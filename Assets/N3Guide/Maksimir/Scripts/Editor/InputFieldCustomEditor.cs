...
namespace TMPro.EditorUtilities {
	...
	[CustomEditor(typeof(InputFieldCustom), true)]
	public class InputFieldCustomEditor : SelectableEditor {
		...
		public override void OnInspectorGUI()
		{
			...
			if (m_foldout.fontSettings)
			{
				...
				{
					InputFieldCustom inputField = target as InputFieldCustom;
				...
				if (!m_ContentType.hasMultipleDifferentValues)
				{
					...
					if (m_ContentType.enumValueIndex == (int)InputFieldCustom.ContentType.Standard ||
							m_ContentType.enumValueIndex == (int)InputFieldCustom.ContentType.Autocorrected ||
							m_ContentType.enumValueIndex == (int)InputFieldCustom.ContentType.Custom)
					{
						EditorGUI.BeginChangeCheck();
						...
						if (EditorGUI.EndChangeCheck())
						{
							if (text != null)
							{
								if (m_LineType.enumValueIndex == (int)InputFieldCustom.LineType.SingleLine)
					...
					if (m_ContentType.enumValueIndex == (int)InputFieldCustom.ContentType.Custom)
					{
						...
						if (m_CharacterValidation.enumValueIndex == (int)InputFieldCustom.CharacterValidation.Regex)
						{
							EditorGUILayout.PropertyField(m_RegexValue);
						}
						else if (m_CharacterValidation.enumValueIndex == (int)InputFieldCustom.CharacterValidation.CustomValidator)
						{
